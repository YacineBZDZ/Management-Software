...
namespace EIA2MININFPOOP6 {
	...
	private: NS_SVC::Gestionclient^ gestionClients;
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   // btn_first
			   // 
			   this->btn_first->Location = System::Drawing::Point(29, 216);
			   ...
			   this->btn_first->Click += gcnew System::EventHandler(this, &Principale::button1_Click);
			   // 
			   // txt_id
			   // 
			   ...
			   // txt_nom
			   // 
			   this->txt_nom->Location = System::Drawing::Point(29, 78);
			   ...
			   this->lbl_id->Location = System::Drawing::Point(25, 9);
			   ...
			   this->lbl_nom->Location = System::Drawing::Point(26, 58);
			   ...
			   this->lbl_prenom->Location = System::Drawing::Point(25, 115);
			   ...
			   // txt_prenom
			   // 
			   this->txt_prenom->Location = System::Drawing::Point(29, 135);
			   ...
			   // btn_previous
			   // 
			   this->btn_previous->Location = System::Drawing::Point(91, 216);
			   ...
			   this->btn_previous->Click += gcnew System::EventHandler(this, &Principale::button1_Click_1);
			   // 
			   // button2
			   // 
			   this->button2->Location = System::Drawing::Point(214, 216);
			   this->button2->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			   this->button2->Name = L"button2";
			   this->button2->Size = System::Drawing::Size(53, 28);
			   this->button2->TabIndex = 8;
			   this->button2->Text = L">>";
			   this->button2->UseVisualStyleBackColor = true;
			   this->button2->Click += gcnew System::EventHandler(this, &Principale::button2_Click);
			   // 
			   // button3
			   // 
			   this->button3->Location = System::Drawing::Point(152, 216);
			   ...
			   this->button3->Click += gcnew System::EventHandler(this, &Principale::button3_Click);
			   // 
			   // dgv_adresses
			   // 
			   ...
			   this->dgv_adresses->Size = System::Drawing::Size(495, 299);
			   ...
			   // btn_nouveau
			   // 
			   this->btn_nouveau->Location = System::Drawing::Point(29, 252);
			   ...
			   this->btn_nouveau->Click += gcnew System::EventHandler(this, &Principale::btn_nouveau_Click);
			   // 
			   // btn_maj
			   // 
			   this->btn_maj->Location = System::Drawing::Point(29, 288);
			   ...
			   this->btn_maj->Click += gcnew System::EventHandler(this, &Principale::btn_maj_Click);
			   // 
			   // btn_sup
			   // 
			   this->btn_sup->Location = System::Drawing::Point(29, 324);
			   ...
			   this->btn_sup->Click += gcnew System::EventHandler(this, &Principale::btn_sup_Click);
			   // 
			   // btn_enr
			   // 
			   this->btn_enr->Location = System::Drawing::Point(152, 252);
			   this->btn_enr->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			   this->btn_enr->Name = L"btn_enr";
			   this->btn_enr->Size = System::Drawing::Size(115, 100);
			   this->btn_enr->TabIndex = 15;
			   this->btn_enr->Text = L"Enregistrer";
			   this->btn_enr->UseVisualStyleBackColor = true;
			   this->btn_enr->Click += gcnew System::EventHandler(this, &Principale::btn_enr_Click);
			   // 
			   // lbl_message
			   // 
			   ...
			   // txtdatenaissance
			   // 
			   this->txtdatenaissance->Location = System::Drawing::Point(29, 186);
			   this->txtdatenaissance->Margin = System::Windows::Forms::Padding(4);
			   this->txtdatenaissance->Name = L"txtdatenaissance";
			   this->txtdatenaissance->Size = System::Drawing::Size(236, 22);
			   this->txtdatenaissance->TabIndex = 19;
			   this->txtdatenaissance->TextChanged += gcnew System::EventHandler(this, &Principale::textBox1_TextChanged);
			   // 
			   // labeldatenaissance
			   // 
			   this->labeldatenaissance->AutoSize = true;
			   this->labeldatenaissance->Location = System::Drawing::Point(25, 166);
			   ...
			   this->labeldatenaissance->TabIndex = 18;
			   this->labeldatenaissance->Text = L"Date de naissance";
			   this->labeldatenaissance->Click += gcnew System::EventHandler(this, &Principale::label1_Click);
			   // 
			   // Principale
			   // 
			   this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			   this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			   this->ClientSize = System::Drawing::Size(813, 449);
			   ...
			   this->Text = L"MyForm";
			   this->Load += gcnew System::EventHandler(this, &Principale::MyForm_Load);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		this->txtdatenaissance->Text = Convert::ToString(this->dsPersonne->Tables["LesClients"]->Rows[this->index]->ItemArray[3]);
	...
	private: System::Void btn_enr_Click(System::Object^ sender, System::EventArgs^ e)
	{
		if (this->mode == "nouveau")
		{
			...
			this->gestionClients->ajouter(this->txt_nom->Text, this->txt_prenom->Text, Convert::ToDateTime(this->txtdatenaissance->Text));
		}
		...
		else if (this->mode == "maj")
		{
			...
			ii = 0;
			this->gestionClients->modifier(Convert::ToInt32(this->txt_id->Text), this->txt_nom->Text, this->txt_prenom->Text, Convert::ToDateTime(this->txtdatenaissance->Text));
		}
		this->initialisationENR();
	}
	...
	{
		this->gestionClients = gcnew NS_SVC::Gestionclient();
		...
		this->txtdatenaissance->Text = Convert::ToString(this->dsPersonne->Tables["LesClients"]->Rows[0]->ItemArray[3]);
